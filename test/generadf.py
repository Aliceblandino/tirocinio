...
# Scrivo file Excel
# --------------------------
with pd.ExcelWriter("Appello_Completo.xlsx", engine="xlsxwriter") as writer:
    ...
    # Scrivo il DataFrame a partire dalla riga successiva
    start_row = len(intestazioni) + 1
    studenti.to_excel(writer, sheet_name="Appello", startrow=start_row, index=False)
    
print("File 'Appello_Completo.xlsx' creato con successo!")
